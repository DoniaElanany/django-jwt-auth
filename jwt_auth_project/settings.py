...
SECRET_KEY = 'django-insecure-zs09u71&o48-9xi$#ub9h#$*r-=gzx+nc0$pw4di6=wb0(to23'
...
INSTALLED_APPS = [
    ...
    # Third-party apps
    'rest_framework', # * Django REST Framework - enables API building
    'rest_framework_simplejwt', # * Simple JWT - provides JWT authentication support
